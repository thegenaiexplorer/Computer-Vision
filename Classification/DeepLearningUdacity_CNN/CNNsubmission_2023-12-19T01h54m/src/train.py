...
def train_one_epoch(train_dataloader, model, optimizer, loss):
    ...
    for batch_idx, (data, target) in tqdm(
        ...
        ##Added for more reporting during training
    ...
    print('\Train Accuracy: %2d%% (%2d/%2d)' % (100. * correct / total, correct, total))
    
    ### End of added code for reporting during training
    return train_loss
...
def valid_one_epoch(valid_dataloader, model, loss):
    ...
    with torch.no_grad():
        ...
        for batch_idx, (data, target) in tqdm(
            ...
            ## Code added for extra reporting during training
            pred  = torch.argmax(output, dim=-1) # YOUR CODE HERE
...
def optimize(data_loaders, model, optimizer, loss, n_epochs, save_path, interactive_tracking=False):
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode="min", verbose=True, threshold=0.01)
    # YOUR CODE HERE
